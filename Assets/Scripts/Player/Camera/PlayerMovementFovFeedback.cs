...
public sealed class PlayerMovementFovFeedback : MonoBehaviour
{
    ...
    [SerializeField] private List<MovementFovStateSettings> stateFovSettings = new List<MovementFovStateSettings>
    {
        ...
        new MovementFovStateSettings(MovementState.jumping, 0f, 0.12f, 0.16f),
        new MovementFovStateSettings(MovementState.air, 0f, 0.12f, 0.16f)
    };
    ...
    {
        MovementState currentState = playerMovement.CurrentState;
