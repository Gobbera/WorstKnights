...
{
    static readonly int WobbleXProperty = Shader.PropertyToID("_WobbleX");
    static readonly int WobbleZProperty = Shader.PropertyToID("_WobbleZ");
    static readonly int FillAmountProperty = Shader.PropertyToID("_FillAmount");
    ...
    void ApplyMaterialProperties()
    {
        ...
        propertyBlock.SetFloat(WobbleXProperty, wobbleAmountX);
        propertyBlock.SetFloat(WobbleZProperty, wobbleAmountZ);
        propertyBlock.SetVector(FillAmountProperty, pos);
